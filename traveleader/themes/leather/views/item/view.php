...
<!--  
    ...
    <div class="deal container_24">
        ...
        <div class="deal_pic clearfix">
            ...
            <div style="width: 350px; height: 250px; overflow: hidden; position: relative;" id=idTransformView >
                <ul id=idSlider class=slider>
                    <?php foreach ($item->itemImgs as $itemImg) {
                        if($itemImg->pic){
                            $picUrl=$imageHelper->thumb('350','250',$itemImg->pic);
                        }else $picUrl=$item->getHolderJs('350','250');
        ...
        <form action="<?php echo Yii::app()->createUrl('order/checkout'); ?>" method="post" class="deal_info" id="deal">
            ...
            <div class="deal_price">
                <span class="cor_red bold font30"><?php echo $item->currency . $item->price ?></span><span>起</span>
            </div>
